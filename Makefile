...
generate_devcontainer_env:
	...
	@echo "USERNAME=${DOCKER_USERNAME}" >> $(DEVCONTAINER_BUILD_TIME_ENV_FILE)
	@echo "USER_UID=${DOCKER_UID}" >> $(DEVCONTAINER_BUILD_TIME_ENV_FILE)
	@echo "USER_GID=${DOCKER_GID}" >> $(DEVCONTAINER_BUILD_TIME_ENV_FILE)
